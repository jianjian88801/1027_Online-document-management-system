    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="人员架构" prop="renyuanjiagou">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.renyuanjiagou" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.renyuanjiagou" label="人员架构" prop="renyuanjiagou">
                    <span v-html="ruleForm.renyuanjiagou"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.renshu = true;
          ...
          if(o=='renyuanjiagou'){
            this.ruleForm.renyuanjiagou = obj[o];
	    this.ro.renyuanjiagou = true;
            continue;
          }
        }
      }
	...
	this.ruleForm.renyuanjiagou = this.ruleForm.renyuanjiagou.replace(reg,'../../../springbootpkh49/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
